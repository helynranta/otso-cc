...
app.post('/sendMail', function(reg, res) {
    ...
    html: '<b>Greetings! ✔</b><br> Please answer to this feedback form: <br/><a href=https://otso-cc-lasshi.c9users.io/feedback/'+reg.body.id+'>https://otso-cc-lasshi.c9users.io/feedback/'+reg.body.id+'</a><br>Thanks, Paavon Sähkö' // html body
    };
